...
export default function Home() {
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
      <section className="bg-gray-800 dark:bg-gray-800 text-white dark:text-gray-200 text-center py-16 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold mb-4 animate__animated animate__fadeIn">Bienvenido a SneakerStore</h1>
          ...
          <Link href="/shop" className="bg-blue-500 dark:bg-blue-600 text-white dark:text-gray-900 px-6 py-3 rounded hover:bg-blue-600 dark:hover:bg-blue-700 transition transform hover:scale-105">
              Explorar Colección
          </Link>
        </div>
      ...
      <section className="bg-gray-200 dark:bg-gray-800 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 animate__animated animate__fadeIn">Marcas Destacadas</h2>
          <p className="text-lg mb-8 animate__animated animate__fadeIn animate__delay-1s">
      ...
      <section className="bg-blue-500 dark:bg-blue-700 text-white dark:text-gray-200 text-center py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4 animate__animated animate__fadeIn">¡No te lo pierdas!</h2>
          <p className="text-lg mb-8 animate__animated animate__fadeIn animate__delay-1s">
          ...
          <Link href="/subscribe" className="bg-white dark:bg-gray-800 text-blue-500 dark:text-white px-6 py-3 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition transform hover:scale-105">
              Suscribirse
          </Link>
        </div>
      </section>
