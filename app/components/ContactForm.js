...
const ContactForm = () => {
  ...
  return (
    <div className="contact-form max-w-md mx-auto p-4 border rounded shadow-lg bg-white dark:bg-gray-800">
      <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">¡Contáctanos!</h1>
